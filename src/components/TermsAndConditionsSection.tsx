...
export default function TermsAndConditionsSection({ onBack }: TermsAndConditionsSectionProps) {
  ...
  return (
    <article className="relative min-h-screen py-28 px-6 md:px-10 max-w-4xl mx-auto z-15 flex flex-col justify-start">
      {/* Background radial purple glow blots */}
      <div className="absolute top-[10%] left-[-20%] w-[350px] h-[350px] bg-[#7B2FF7]/10 rounded-full blur-[100px] pointer-events-none" />
      <div className="absolute bottom-[10%] right-[-20%] w-[350px] h-[350px] bg-[#9D4EDD]/10 rounded-full blur-[100px] pointer-events-none" />
      ...
      {/* Header Title Block */}
      <div className="mb-14">
        <span className="font-mono text-[10px] tracking-[0.6em] text-[#7B2FF7] uppercase block mb-3">CONTRACT GUIDELINES</span>
        <h1 className="font-display text-4xl sm:text-5xl font-extralight tracking-tight text-white uppercase leading-none">
          SYSTEM <span className="text-[#7B2FF7] font-semibold tracking-wide">PROTOCOLS</span>
        </h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 border-y border-white/10 py-8 mb-12 text-left bg-white/[0.03] rounded-xl px-6">
        ...
        <div className="flex items-center gap-3">
          <HelpCircle className="w-4 h-4 text-[#7B2FF7] shrink-0" />
          <div>
      ...
      <div className="flex flex-col gap-10 font-sans text-sm text-gray-300 leading-relaxed text-left">
        ...
        <section className="flex flex-col gap-3">
          <h2 className="font-display text-lg font-medium tracking-wide text-white flex items-center gap-2">
            <span className="font-mono text-xs text-[#7B2FF7]">01.</span>
        ...
        <section className="flex flex-col gap-3">
          <h2 className="font-display text-lg font-medium tracking-wide text-white flex items-center gap-2">
            <span className="font-mono text-xs text-[#7B2FF7]">02.</span>
        ...
        <section className="flex flex-col gap-3">
          <h2 className="font-display text-lg font-medium tracking-wide text-white flex items-center gap-2">
            <span className="font-mono text-xs text-[#7B2FF7]">03.</span>
        ...
        <section className="flex flex-col gap-3">
          <h2 className="font-display text-lg font-medium tracking-wide text-white flex items-center gap-2">
            <span className="font-mono text-xs text-[#7B2FF7]">04.</span>
        ...
        <section className="flex flex-col gap-3">
          <h2 className="font-display text-lg font-medium tracking-wide text-white flex items-center gap-2">
            <span className="font-mono text-xs text-[#7B2FF7]">05.</span>
        ...
        <section className="flex flex-col gap-3">
          <h2 className="font-display text-lg font-medium tracking-wide text-white flex items-center gap-2">
            <span className="font-mono text-xs text-[#7B2FF7]">06.</span>
        ...
        <section className="flex flex-col gap-3">
          <h2 className="font-display text-lg font-medium tracking-wide text-white flex items-center gap-2">
            <span className="font-mono text-xs text-[#7B2FF7]">07.</span>
        ...
        <section className="flex flex-col gap-3">
          <h2 className="font-display text-lg font-medium tracking-wide text-white flex items-center gap-2">
            <span className="font-mono text-xs text-[#7B2FF7]">08.</span>
      ...
      <div className="mt-16 pt-10 border-t border-white/5 flex justify-center">
        <button 
          onClick={onBack}
          className="px-8 py-3.5 rounded-full font-display text-xs tracking-widest uppercase font-semibold text-white bg-gradient-to-r from-[#7B2FF7] to-[#9D4EDD] hover:scale-[1.03] transition-all flex items-center justify-center gap-2 shadow-[0_0_20px_rgba(123,47,247,0.2)] hover:shadow-[0_0_35px_rgba(123,47,247,0.55)] cursor-pointer select-none"
        >
