...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-[#020202] border-t border-white/5 pt-20 pb-10 px-6 md:px-10 z-15">
      ...
      <div className="absolute top-0 inset-x-0 h-[1px] bg-gradient-to-r from-transparent via-brand-violet/35 to-transparent" />
      ...
      <div className="max-w-7xl mx-auto flex flex-col gap-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 items-start">
          ...
          <div className="md:col-span-5 flex flex-col gap-4">
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                <span className="font-mono text-[8px] tracking-[0.45em] text-brand-violet font-bold">STUDIO</span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 mt-2">
              <a href="#" className="w-8 h-8 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:text-brand-violet hover:border-brand-violet/50 transition-colors">
          ...
          <div className="md:col-span-4 flex flex-col gap-4">
            <h4 className="font-mono text-[10px] tracking-[0.3em] font-bold text-brand-violet uppercase">
              INDEX REGISTRY
            </h4>
            ...
            <div className="grid grid-cols-2 gap-x-4 gap-y-2.5">
              {navLinks.map((link) => (
                <button
                  ...
                  className="font-sans text-[11px] text-gray-400 hover:text-brand-violet transition-colors text-left font-semibold uppercase tracking-wider cursor-pointer"
                >
                  {link.label}
                </button>
              ))}
          ...
          <div className="md:col-span-3 flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-3 font-sans text-xs text-gray-400">
              ...
              >
                <div className="w-4 h-4 rounded-full bg-brand-violet/10 flex items-center justify-center shrink-0">
                  <span className="text-[8px] font-bold text-brand-violet">W</span>
                </div>
